...
URL = "https://floridagators.com/sports/womens-lacrosse/roster"
...
for element in soup.find_all('span', {'class': 'sidearm-roster-player-position-long-short hide-on-small-down'}):
...
db.child("rosters").child('womens_lacrosse').set(dictionaryList)